...
- This class is primarily used for:
  1. Performing tasks that need to run before the creation of your first activity,
  2. initialization of global values that needs to be shared across all components (crash reporting, persistence)
