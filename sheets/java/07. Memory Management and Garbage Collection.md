## Contents
  ...
  * [How long does object live](#how-long-does-object-live)
...
```
Here reference ```z``` dies at the end of the method.
...
z = new Life();
```
The first object is abandoned, when ```z``` is provided reference of a new object.
...
z = null;
```
The first object is abandoned when we make the value of ```z``` null.
