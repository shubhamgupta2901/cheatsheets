...
public class RunnableTask implements Runnable {
    ...
    public RunnableTask(int id, long startTime) {
        this.id = id;
    ...
    public void run() {
        ...
        System.out.println("Completed Task "+ id +"." + timeTaken+"  milliseconds after starting the executor.");
...
Starting Task 2
Starting Task 1
Completed Task 2.5057  milliseconds after starting the executor.
Starting Task 3
Completed Task 1.5066  milliseconds after starting the executor.
Starting Task 4
Completed Task 3.10172  milliseconds after starting the executor.
Starting Task 5
Completed Task 4.10168  milliseconds after starting the executor.
Completed Task 5.15167  milliseconds after starting the executor.
All tasks completed.
```

* A Thread pool is like having a number of workers in a factory. In this case, 2 of them. There is a list of task that we want them to process, in this case 5.

* Each thread processes a task. And when it is done with the task. We will assign it new task.
