...
* The most common difference is :  
  * When you extend a Thread class, after that you can’t extend any other class which you required because Java does not allow inheriting more than one class.
...
* The significant difference is: 
 ...
 In other words, In the ```Runnable``` interface approach, only one instance of a class is being created and it has been shared by different threads.
